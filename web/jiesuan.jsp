        ...
        <nav class="navbar navbar-default">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <h1><a href="index.html"><span>真正 </span>空间</a></h1>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="2columnsgallery.html">2列画廊</a></li>
                            <li><a href="3columnsgallery.html">3列画廊</a></li>
                            <li><a href="4columnsgallery.html">4列画廊</a></li>
                        </ul>
                    </li>
                ...
                <div class="col-md-9 properties-left">
                    ...
                    <div class="properties-details">
                        <div class="col-md-2 properties-detail">
                            <h5><span>5000</span>区域</h5>
                        </div>
                        <div class="col-md-2 properties-detail">
                            <h5><span>3</span>浴室</h5>
                        </div>
                        <div class="col-md-2 properties-detail">
                            <h5><span>4</span>张床</h5>
                        </div>
                        <div class="col-md-2 properties-detail">
                            <h5><span>3</span>停车场</h5>
                        </div>
                        <div class="col-md-2 properties-detail">
                            <a href="#">最爱</a>
                        </div>
